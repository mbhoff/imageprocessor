...
--for k, v in pairs(il) do io.write(tostring(k).."\t"..tostring(v).."\n") end
-----------
-- menus --
-----------
...
imageMenu("Histogram processes",
  {
    ...
    {"Display Greyscale Histogram", il.showHistogram},
  }
)
...
imageMenu("Misc",
  {
    ...
    {"Size Filter", il.sizeFilter,
      {{name = "epsilon", type = "number", displaytype = "slider", default = 16, min = 0, max = 128},
