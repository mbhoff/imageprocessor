...
imageMenu("Edge detection",
  {
    ...
    {"Horizontal Edges", il.edgeHorizontal},
    {"Vertical Edges", il.edgeVertical},
    {"Kirsch Edge Mag", il.kirschMag},
    {"Kirsch Edge Dir", il.kirschDir},
    {"Laplacian", il.laplacian},
    {"Laplacian for z.c.", il.laplacianZero},
